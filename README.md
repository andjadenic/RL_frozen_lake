...
To give a gentle introduction to the field of reinforcement learning I wrote [this paper]([url](https://github.com/andjadenic/RL_frozen_lake/blob/main/A%20gentle%20introduction%20to%20Reinforcement%20Learning.pdf)) that explains basic methods using the popular Toy Text environment in **Gymnasium Frozen Lake**.
